...
def write_JSON(filepath, some_JSON_data):
...
def main():
    ...
    if parsed_input.run == True:
        ...
        continue_var = input("\nThis will delete all your entries. Are you sure you want to continue? Press <Y> to continue and any other key to abort. \n\n")
        if continue_var.lower() == "y":
            write_JSON(json_filepath, working_dict.reset_dict())
        else:
    ...
    if parsed_input.run == False:
        write_JSON(json_filepath, working_dict.get_dict()) #writes data to JSON file
    ...
    while run_program == True:
        ...
        write_JSON(json_filepath, working_dict.get_dict())
